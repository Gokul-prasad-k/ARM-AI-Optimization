/**
  ...
  ******************************************************************************
  */
#ifndef AI_NETWORK_EE_H
#define AI_NETWORK_EE_H

#include "network_ee_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_NETWORK_EE_MODEL_NAME          "network_ee"
#define AI_NETWORK_EE_ORIGIN_MODEL_NAME   "ee1"

/******************************************************************************/
#define AI_NETWORK_EE_ACTIVATIONS_ALIGNMENT   (4)
#define AI_NETWORK_EE_INPUTS_IN_ACTIVATIONS   (4)
#define AI_NETWORK_EE_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_NETWORK_EE_IN_NUM        (1)

AI_DEPRECATED
#define AI_NETWORK_EE_IN \
  ai_network_ee_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_EE_IN_SIZE { \
  AI_NETWORK_EE_IN_1_SIZE, \
}
#define AI_NETWORK_EE_IN_SIZE_BYTES { \
  AI_NETWORK_EE_IN_1_SIZE_BYTES, \
}
#define AI_NETWORK_EE_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_NETWORK_EE_IN_1_HEIGHT      (25)
#define AI_NETWORK_EE_IN_1_WIDTH       (5)
#define AI_NETWORK_EE_IN_1_CHANNEL     (64)
#define AI_NETWORK_EE_IN_1_SIZE        (8000)
#define AI_NETWORK_EE_IN_1_SIZE_BYTES  (32000)

/******************************************************************************/
#define AI_NETWORK_EE_OUT_NUM       (1)

AI_DEPRECATED
#define AI_NETWORK_EE_OUT \
  ai_network_ee_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_EE_OUT_SIZE { \
  AI_NETWORK_EE_OUT_1_SIZE, \
}
#define AI_NETWORK_EE_OUT_SIZE_BYTES { \
  AI_NETWORK_EE_OUT_1_SIZE_BYTES, \
}
#define AI_NETWORK_EE_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_NETWORK_EE_OUT_1_CHANNEL     (12)
#define AI_NETWORK_EE_OUT_1_SIZE        (12)
#define AI_NETWORK_EE_OUT_1_SIZE_BYTES  (48)

/******************************************************************************/
#define AI_NETWORK_EE_N_NODES (3)
 ...
 * @ref ai_network_ee_create. Both the activations memory buffer 
 ...
 * using @ref ai_network_ee_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_ee_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_ee_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_NETWORK_EE_*
 * defines into file @ref network_ee.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_network_ee_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_NETWORK_EE_H */
