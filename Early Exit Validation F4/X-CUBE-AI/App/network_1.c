...
#define AI_NETWORK_1_MODEL_SIGNATURE     "0x00f35b01bb86bdffd1310d28376fd50e"
...
#define AI_TOOLS_DATE_TIME   "2026-08-14T23:48:28+0530"
...
/* Array#10 */
AI_ARRAY_OBJ_DECLARE(
  nl_4_nl_output_array, AI_ARRAY_FORMAT_FLOAT|AI_FMT_FLAG_IS_IO,
  NULL, NULL, 8000, AI_STATIC)
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_1_OUT_NUM, &nl_4_nl_output),
  &conv2d_0_layer, 0x3f4d611f, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_1_activations_map, 1, params)) {
    ...
    serving_default_input_10_output_array.data = AI_PTR(g_network_1_activations_map[0] + 7096);
    serving_default_input_10_output_array.data_start = AI_PTR(g_network_1_activations_map[0] + 7096);
    conv2d_0_scratch0_array.data = AI_PTR(g_network_1_activations_map[0] + 9056);
    conv2d_0_scratch0_array.data_start = AI_PTR(g_network_1_activations_map[0] + 9056);
    conv2d_0_output_array.data = AI_PTR(g_network_1_activations_map[0] + 9216);
    conv2d_0_output_array.data_start = AI_PTR(g_network_1_activations_map[0] + 9216);
    nl_0_nl_output_array.data = AI_PTR(g_network_1_activations_map[0] + 9216);
    nl_0_nl_output_array.data_start = AI_PTR(g_network_1_activations_map[0] + 9216);
    conv2d_1_output_array.data = AI_PTR(g_network_1_activations_map[0] + 5888);
    conv2d_1_output_array.data_start = AI_PTR(g_network_1_activations_map[0] + 5888);
    nl_1_nl_output_array.data = AI_PTR(g_network_1_activations_map[0] + 5888);
    nl_1_nl_output_array.data_start = AI_PTR(g_network_1_activations_map[0] + 5888);
    conv2d_2_scratch0_array.data = AI_PTR(g_network_1_activations_map[0] + 37888);
    conv2d_2_scratch0_array.data_start = AI_PTR(g_network_1_activations_map[0] + 37888);
    conv2d_2_output_array.data = AI_PTR(g_network_1_activations_map[0] + 4608);
    conv2d_2_output_array.data_start = AI_PTR(g_network_1_activations_map[0] + 4608);
    nl_2_nl_output_array.data = AI_PTR(g_network_1_activations_map[0] + 4608);
    nl_2_nl_output_array.data_start = AI_PTR(g_network_1_activations_map[0] + 4608);
    conv2d_3_output_array.data = AI_PTR(g_network_1_activations_map[0] + 1280);
    conv2d_3_output_array.data_start = AI_PTR(g_network_1_activations_map[0] + 1280);
    nl_3_nl_output_array.data = AI_PTR(g_network_1_activations_map[0] + 1280);
    nl_3_nl_output_array.data_start = AI_PTR(g_network_1_activations_map[0] + 1280);
    conv2d_4_scratch0_array.data = AI_PTR(g_network_1_activations_map[0] + 33280);
    conv2d_4_scratch0_array.data_start = AI_PTR(g_network_1_activations_map[0] + 33280);
    conv2d_4_output_array.data = AI_PTR(g_network_1_activations_map[0] + 0);
    conv2d_4_output_array.data_start = AI_PTR(g_network_1_activations_map[0] + 0);
    nl_4_nl_output_array.data = AI_PTR(g_network_1_activations_map[0] + 0);
    nl_4_nl_output_array.data_start = AI_PTR(g_network_1_activations_map[0] + 0);
    return true;
  }
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_1_weights_map, 1, params)) {
    ...
    conv2d_0_bias_array.data = AI_PTR(g_network_1_weights_map[0] + 10240);
    conv2d_0_bias_array.data_start = AI_PTR(g_network_1_weights_map[0] + 10240);
    conv2d_1_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_1_weights_array.data = AI_PTR(g_network_1_weights_map[0] + 10496);
    conv2d_1_weights_array.data_start = AI_PTR(g_network_1_weights_map[0] + 10496);
    conv2d_1_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_1_bias_array.data = AI_PTR(g_network_1_weights_map[0] + 12800);
    conv2d_1_bias_array.data_start = AI_PTR(g_network_1_weights_map[0] + 12800);
    conv2d_2_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_2_weights_array.data = AI_PTR(g_network_1_weights_map[0] + 13056);
    conv2d_2_weights_array.data_start = AI_PTR(g_network_1_weights_map[0] + 13056);
    conv2d_2_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_2_bias_array.data = AI_PTR(g_network_1_weights_map[0] + 29440);
    conv2d_2_bias_array.data_start = AI_PTR(g_network_1_weights_map[0] + 29440);
    conv2d_3_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_3_weights_array.data = AI_PTR(g_network_1_weights_map[0] + 29696);
    conv2d_3_weights_array.data_start = AI_PTR(g_network_1_weights_map[0] + 29696);
    conv2d_3_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_3_bias_array.data = AI_PTR(g_network_1_weights_map[0] + 32000);
    conv2d_3_bias_array.data_start = AI_PTR(g_network_1_weights_map[0] + 32000);
    conv2d_4_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_4_weights_array.data = AI_PTR(g_network_1_weights_map[0] + 32256);
    conv2d_4_weights_array.data_start = AI_PTR(g_network_1_weights_map[0] + 32256);
    conv2d_4_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_4_bias_array.data = AI_PTR(g_network_1_weights_map[0] + 48640);
    conv2d_4_bias_array.data_start = AI_PTR(g_network_1_weights_map[0] + 48640);
    return true;
  }
