...
#define AI_NETWORK_2_DATA_ACTIVATIONS_START_ADDR 0xFFFFFFFF
#define AI_NETWORK_EE_DATA_ACTIVATIONS_START_ADDR 0xFFFFFFFF

#define AI_MNETWORK_DATA_ACTIVATIONS_INT_SIZE AI_NETWORK_2_DATA_ACTIVATIONS_SIZE
