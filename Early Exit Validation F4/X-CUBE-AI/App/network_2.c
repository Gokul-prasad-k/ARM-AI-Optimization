...
#define AI_NETWORK_2_MODEL_SIGNATURE     "0xf6b4ea53ff5851f9ea7202965124a005"
...
#define AI_TOOLS_DATE_TIME   "2026-08-14T23:48:46+0530"
...
AI_ARRAY_OBJ_DECLARE(
  serving_default_kws_split_input0_output_array, AI_ARRAY_FORMAT_FLOAT|AI_FMT_FLAG_IS_IO,
...
/* Tensor #23 */
AI_TENSOR_OBJ_DECLARE(
  serving_default_kws_split_input0_output, AI_STATIC,
  23, 0x0,
  AI_SHAPE_INIT(4, 1, 64, 5, 25), AI_STRIDE_INIT(4, 4, 4, 256, 1280),
  1, &serving_default_kws_split_input0_output_array, NULL)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &serving_default_kws_split_input0_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &conv2d_0_output),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 41520, 1, 1),
    41520, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 41216, 1, 1),
    41216, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_2_IN_NUM, &serving_default_kws_split_input0_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_2_OUT_NUM, &nl_7_output),
  &conv2d_0_layer, 0x0f7f9ab8, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_2_activations_map, 1, params)) {
    ...
    serving_default_kws_split_input0_output_array.data = AI_PTR(g_network_2_activations_map[0] + 9216);
    serving_default_kws_split_input0_output_array.data_start = AI_PTR(g_network_2_activations_map[0] + 9216);
    conv2d_0_output_array.data = AI_PTR(g_network_2_activations_map[0] + 5888);
    conv2d_0_output_array.data_start = AI_PTR(g_network_2_activations_map[0] + 5888);
    nl_0_nl_output_array.data = AI_PTR(g_network_2_activations_map[0] + 5888);
    nl_0_nl_output_array.data_start = AI_PTR(g_network_2_activations_map[0] + 5888);
    conv2d_1_scratch0_array.data = AI_PTR(g_network_2_activations_map[0] + 37888);
    conv2d_1_scratch0_array.data_start = AI_PTR(g_network_2_activations_map[0] + 37888);
    conv2d_1_output_array.data = AI_PTR(g_network_2_activations_map[0] + 4608);
    conv2d_1_output_array.data_start = AI_PTR(g_network_2_activations_map[0] + 4608);
    nl_1_nl_output_array.data = AI_PTR(g_network_2_activations_map[0] + 4608);
    nl_1_nl_output_array.data_start = AI_PTR(g_network_2_activations_map[0] + 4608);
    conv2d_2_output_array.data = AI_PTR(g_network_2_activations_map[0] + 1280);
    conv2d_2_output_array.data_start = AI_PTR(g_network_2_activations_map[0] + 1280);
    nl_2_nl_output_array.data = AI_PTR(g_network_2_activations_map[0] + 1280);
    nl_2_nl_output_array.data_start = AI_PTR(g_network_2_activations_map[0] + 1280);
    conv2d_3_scratch0_array.data = AI_PTR(g_network_2_activations_map[0] + 33280);
    conv2d_3_scratch0_array.data_start = AI_PTR(g_network_2_activations_map[0] + 33280);
    ...
    nl_3_nl_output_array.data = AI_PTR(g_network_2_activations_map[0] + 0);
    nl_3_nl_output_array.data_start = AI_PTR(g_network_2_activations_map[0] + 0);
    pool_4_output_array.data = AI_PTR(g_network_2_activations_map[0] + 32000);
    pool_4_output_array.data_start = AI_PTR(g_network_2_activations_map[0] + 32000);
    gemm_6_output_array.data = AI_PTR(g_network_2_activations_map[0] + 0);
    gemm_6_output_array.data_start = AI_PTR(g_network_2_activations_map[0] + 0);
    nl_7_output_array.data = AI_PTR(g_network_2_activations_map[0] + 48);
    nl_7_output_array.data_start = AI_PTR(g_network_2_activations_map[0] + 48);
    return true;
  }
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_2_weights_map, 1, params)) {
    ...
    conv2d_0_bias_array.data = AI_PTR(g_network_2_weights_map[0] + 2304);
    conv2d_0_bias_array.data_start = AI_PTR(g_network_2_weights_map[0] + 2304);
    conv2d_1_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_1_weights_array.data = AI_PTR(g_network_2_weights_map[0] + 2560);
    conv2d_1_weights_array.data_start = AI_PTR(g_network_2_weights_map[0] + 2560);
    conv2d_1_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_1_bias_array.data = AI_PTR(g_network_2_weights_map[0] + 18944);
    conv2d_1_bias_array.data_start = AI_PTR(g_network_2_weights_map[0] + 18944);
    conv2d_2_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_2_weights_array.data = AI_PTR(g_network_2_weights_map[0] + 19200);
    conv2d_2_weights_array.data_start = AI_PTR(g_network_2_weights_map[0] + 19200);
    conv2d_2_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_2_bias_array.data = AI_PTR(g_network_2_weights_map[0] + 21504);
    conv2d_2_bias_array.data_start = AI_PTR(g_network_2_weights_map[0] + 21504);
    conv2d_3_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_3_weights_array.data = AI_PTR(g_network_2_weights_map[0] + 21760);
    conv2d_3_weights_array.data_start = AI_PTR(g_network_2_weights_map[0] + 21760);
    conv2d_3_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_3_bias_array.data = AI_PTR(g_network_2_weights_map[0] + 38144);
    conv2d_3_bias_array.data_start = AI_PTR(g_network_2_weights_map[0] + 38144);
    gemm_6_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_6_weights_array.data = AI_PTR(g_network_2_weights_map[0] + 38400);
    gemm_6_weights_array.data_start = AI_PTR(g_network_2_weights_map[0] + 38400);
    gemm_6_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_6_bias_array.data = AI_PTR(g_network_2_weights_map[0] + 41472);
    gemm_6_bias_array.data_start = AI_PTR(g_network_2_weights_map[0] + 41472);
    return true;
  }
